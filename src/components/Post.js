      ...
      <div className="post-wrapper" key={post._id}>
        <div className="post-header">
          <div className="post-avatar">
            <Link to={`/users/${posts.user._id}`}>
              <img
                src="https://cdn-icons.flaticon.com/png/512/2102/premium/2102647.png?token=exp=1648699774~hmac=2c9f08ec0e724477ecb53e5b44c3b387"
                alt="user-pic"
              />
            </Link>
            <div>
          ...
          <div className="post-actions">
            ...
            <div className="post-comments-icon">
              <img
                src="https://cdn-icons-png.flaticon.com/512/54/54761.png"
                alt="comments-icon"
              />
          ...
          <div className="post-comments-list">
            {post.comments.map((comment) => (
              <Comment comment={comment} key={comment._id} postId={post._is} />
            ))}
          </div>
        </div>
      </div>
